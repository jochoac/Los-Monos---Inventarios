...
namespace Logica
{
    public class Usuario
    {
        ...
        public string Registro_usu()
        {
            ...
            Registro_Empleado.Parameters.Add("@Cargo", cargo_usu);
            Registro_Empleado.Parameters.Add("@ID", id_e);
            Registro_Empleado.Parameters.Add("@Telefono", telefono_e);
            Registro_Empleado.Parameters.Add("@Estado", "Activo");
            Registro_Empleado.Parameters.Add("@Correo", correo_usu);
